...
export function CreativeRouteFrame({ route }: { route: CreativeRoute }) {
  ...
  return <Group x={position.x} y={position.y} listening={false}>
    <Rect width={width} height={height} fill="rgba(238,232,220,0.18)" stroke={approved ? '#217a3a' : '#4779b8'} strokeWidth={2} dash={approved ? undefined : [8, 5]} />
