...
- `1ed3571` — `Show approved proposal on mechanical`; typecheck, 26 unit tests, 5 E2E tests, and build passed. Final evidence was recaptured from this production build after approval, showing the in-bounds reference, matching coordinate receipt, and usable Undo on desktop and phone.
